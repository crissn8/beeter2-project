...
import edu.upc.eetac.dsa.csanchez.beeter2.api.model.User;
...
public class UserResource {
	...
	public User login(User user) {
		...
		String pwdDigest = DigestUtils.md5Hex(user.getPassword()); //añadir hash md5
	...
	public Response getProfile(@QueryParam("username") String username, @Context Request request){
		...
		EntityTag eTag = new EntityTag(user.getEmail() + user.getName());
